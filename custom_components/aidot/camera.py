...
class AidotCamera(CoordinatorEntity[AidotCameraUpdateCoordinator], Camera):
    ...
    def _connect_options(self) -> tuple[bool, bool, bool]:
        """Return (fast_connect, sdes_audio, sdes_fast_liveplay) from options."""
    ...
    async def _prewarm_stream(self) -> None:
        ...
        dc = self.coordinator.device_client
        fast_connect, sdes_audio, sdes_fast_liveplay = self._connect_options()
        try:
