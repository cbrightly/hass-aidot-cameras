...
_VIEW_SERVE_READY_WAIT_S = float(
    os.environ.get("AIDOT_VIEW_SERVE_READY_WAIT_S", "25")
)
...
class AidotCamera(CoordinatorEntity[AidotCameraUpdateCoordinator], Camera):
    ...
    def _serve_ready_wait_budget() -> float:
        ...
        return _HLS_SERVE_READY_WAIT_S if _STREAM_SOURCE_HLS.get() else _VIEW_SERVE_READY_WAIT_S
