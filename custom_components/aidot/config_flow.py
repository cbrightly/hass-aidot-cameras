...
class AidotOptionsFlow(OptionsFlow):
    ...
    async def async_step_init(
        ...
        current_fast = self.config_entry.options.get(
            CONF_FAST_CONNECT, DEFAULT_FAST_CONNECT
        )
        ...
        current_persistent_mqtt = self.config_entry.options.get(
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_FAST_CONNECT, default=current_fast
                    ): bool,
                    vol.Optional(
                    ...
                    # Reuse one persistent MQTT connection for camera commands.
                    vol.Optional(
                        CONF_PERSISTENT_MQTT, default=current_persistent_mqtt
                    ): bool,
