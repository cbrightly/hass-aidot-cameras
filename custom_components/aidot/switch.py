...
class AidotSoundDetectionSwitch(AidotEntity, SwitchEntity):
    ...
    def __init__(self, coordinator, key: str) -> None:
        ...
        self._key = key
        self._attr_name = SOUND_DETECTION_NAMES.get(
    ...
    async def _async_set(self, on: bool) -> None:
        await self.coordinator.device_client.async_set_sound_detection(self._key, on)
        ...
        # showing a state the camera never took.
        await self.coordinator.async_refresh_camera_extras(force=True)
