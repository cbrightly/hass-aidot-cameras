...
class AidotCameraUpdateCoordinator(AidotDeviceUpdateCoordinator):
    ...
    def _schedule_camera_extras_inner(self) -> None:
        ...
        # start would take an hour and a half to show a full set. Until every key
        # has been asked for, make the next poll due immediately instead.
        #
        ...
        # indistinguishable. The real fill time is one key per poll -- about 15
        # minutes for the three -- not 90 seconds.
