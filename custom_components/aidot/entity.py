...
def _via_device_extra(entry_id: "str | None", hub_device_id: "str | None", *,
                      supports_via_device_id: bool) -> "dict[str, Any]":
...
def aidot_device_info(info: DeviceInformation, via_device_id: str | None = None,
                      hub_device_id: str | None = None) -> DeviceInfo:
    ...
    extra: dict[str, Any] = _via_device_extra(
        ...
        supports_via_device_id=_SUPPORTS_VIA_DEVICE_ID)
    return DeviceInfo(
