...
Live WebRTC views carry the camera's own audio (G.711). Home Assistant's HLS
fallback player only takes AAC, so in this mode the Picture-card dialog plays
video **without audio**; WebRTC cards are unaffected.
